...
class ColorServiceTests {
	...
	@Test
    void getRandomColorFromThemesContainingColors() {
		Color color = colorService.getRandomColorFromThemesContainingColors(yo.asList())
		
		assertNotNull(color)
    }
	
	@Test
	void getRandomColorFromThemesContainingColorsNone() {
		Color color = colorService.getRandomColorFromThemesContainingColors(ryo.asList())
