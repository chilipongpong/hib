...
<html>
	...
	<body>
		<a href="#edit-valueRange" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-valueRange" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${valueRangeInstance?.version}" />
				<fieldset class="form">
