...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'inspirationBook.label', default: 'My Package')}" />
			...
			<div class="row">
				...
				<div class="col-md-3 col-lg-3 ed-content-nav">
					...
					<ul>
						...
						<li class="active ${inspirationBookInstance.chickens ? "finished" : ""}"><g:link uri="/inspirationBook/chooseChicken">Choose Chicken</g:link></li>
