			...
			<div class="row">
				...
				<div class="col-md-3 col-lg-3 ed-content-nav">
					<ul id="navInspi">
						...
						<h3 class="active">Guest List</h3>
						<ul><li class="active"><g:link uri="/inspirationBook/indicateGuests">Indicate Guests</g:link></li></ul>
						<h3>Food</h3>
							<ul>
						...
						<h3>Supplier</h3>
						<ul><li><g:link uri="/inspirationBook/indicateSuppliers">Indicate Suppliers</g:link></li></ul>
				...
				<div class="col-md-9 col-lg-9 ed-main-content" style="">
					...
					<g:form action="saveGuests">
						...
						<div
							class="fieldcontain ${hasErrors(bean: inspirationBookInstance, field: 'numberOfGuests', 'error')} ">
							<span class="property-label"><g:message code="inspirationBook.guest.label"
									default="Number of Guests" />
							</span>
							<span class="property-value">
							<g:field name="numberOfGuests" type="number"
								value="${inspirationBookInstance.numberOfGuests}" />
							</span>
						</div>
						<div
							class="fieldcontain ${hasErrors(bean: inspirationBookInstance, field: 'sponsorRange', 'error')} ">
							<span class="property-label"> <g:message
									code="inspirationBook.sponsorRange.label"
									default="Number of Sponsors" />

							</span>
							<span class="property-value">
							<g:select name="sponsorRange"
								from="${com.hizon.ValueRange.list()}" optionKey="id"
								value="${inspirationBookInstance?.sponsorRange?.id}"
								class="many-to-one" noSelection="['': '-choose sponsor range-']" />
							</span>
						</div>
						<br />
						<!--Interaction buttons-->
