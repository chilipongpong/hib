			...
			<div class="row">
				...
				<div class="col-md-3 col-lg-3 ed-content-nav">
					...
					<ul>
						...
						<li class="active ${inspirationBookInstance.salads ? "finished" : ""}"><g:link uri="/inspirationBook/chooseSalad">Choose Salad</g:link></li>
				...
				<div class="col-md-9 col-lg-9 ed-main-content" style="">
					<h3 class="ed-progress">Step 6 of 15</h3>
