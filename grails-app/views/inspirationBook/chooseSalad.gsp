		...
		<div id="choose-colors" class="content scaffold-show" role="main">
			...
			<g:form action="saveSalads">
				...
				<div class="fieldcontain ${hasErrors(bean: inspirationBookInstance, field: 'salads', 'error')} ">
					...
					<label>
						<g:message code="inspirationBook.appertizer.label" default="Salad" />
					</label>
					<g:select name="salad1" from="${com.hizon.MenuItem.listSalads()}" optionKey="id" value="${salad1}" noSelection="['':'-Choose a salad-']"/>
					<g:select name="salad2" from="${com.hizon.MenuItem.listSalads()}" optionKey="id" value="${salad2}" noSelection="['':'-Choose a salad-']"/>
				</div>
