...
<html>
	...
	<body>
		...
		<div id="show-package" class="content scaffold-show" role="main">
			<h1><img src="../images/head-pack.png" alt="My Package">My Package</h1>
			...
			<ol class="property-list package">
				...
				<li class="fieldcontain">
					<span id="themeLevel-label" class="property-label"><g:message code="package.themeLevel.label" default="Theme Level" /></span>
						<span class="property-value" aria-labelledby="themeLevel-label"><g:fieldValue bean="${packageInstance}" field="themeLevel"/></span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="appetizer-label" class="property-label"><g:message code="package.appetizer.label" default="Appetizer" /></span>
						<span class="property-value" aria-labelledby="appetizer-label"><g:fieldValue bean="${packageInstance}" field="appetizer"/></span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="soup-label" class="property-label"><g:message code="package.soup.label" default="Soup" /></span>
						<span class="property-value" aria-labelledby="soup-label"><g:fieldValue bean="${packageInstance}" field="soup"/></span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="salad-label" class="property-label"><g:message code="package.salad.label" default="Salad" /></span>
						<span class="property-value" aria-labelledby="salad-label"><g:fieldValue bean="${packageInstance}" field="salad"/></span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="pasta-label" class="property-label"><g:message code="package.pasta.label" default="Pasta" /></span>
						<span class="property-value" aria-labelledby="pasta-label"><g:fieldValue bean="${packageInstance}" field="pasta"/></span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="beef-label" class="property-label"><g:message code="package.beef.label" default="Beef" /></span>
						<span class="property-value" aria-labelledby="beef-label"><g:fieldValue bean="${packageInstance}" field="beef"/></span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="pork-label" class="property-label"><g:message code="package.pork.label" default="Pork" /></span>
						<span class="property-value" aria-labelledby="pork-label"><g:fieldValue bean="${packageInstance}" field="pork"/></span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="chicken-label" class="property-label"><g:message code="package.chicken.label" default="Chicken" /></span>
						<span class="property-value" aria-labelledby="chicken-label"><g:fieldValue bean="${packageInstance}" field="chicken"/></span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="seafood-label" class="property-label"><g:message code="package.seafood.label" default="Seafood" /></span>
						<span class="property-value" aria-labelledby="seafood-label"><g:fieldValue bean="${packageInstance}" field="seafood"/></span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="vegetable-label" class="property-label"><g:message code="package.vegetable.label" default="Vegetable" /></span>
						<span class="property-value" aria-labelledby="vegetable-label"><g:fieldValue bean="${packageInstance}" field="vegetable"/></span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="dessert-label" class="property-label"><g:message code="package.dessert.label" default="Dessert" /></span>
						<span class="property-value" aria-labelledby="dessert-label"><g:fieldValue bean="${packageInstance}" field="dessert"/></span>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="freebies-label" class="property-label"><g:message code="package.freebies.label" default="Freebies" /></span>
						...
						<span class="property-value" aria-labelledby="freebies-label">${f}</span>
						</g:each>
				</li>
				</g:if>
