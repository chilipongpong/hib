									...
									<div class="fieldcontain ${hasErrors(bean: themeInstance, field: 'images', 'error')}">
										...
										<uploadr:add name="themeUploadr${themeInstance.id}" path="${imagesPath}" maxVisible="8" unsupported="/my/controller/action" allowedExtensions="gif,png,jpg,jpeg,GIF,PNG,JPG,JPEG" viewable="false" downloadable="false" maxSize="${imageMaxSize}">
											<g:each in="${images}" var="image">
											    <uploadr:file name="${image.name}" style="margin-top: 20px">
									...
									<div class="col-md-12 col-lg-12"
										...
										<div class="row">
											<div class="col-md-12 col-lg-12 ed-action-btn">
												<g:actionSubmit id="save" class="btn ed-save" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" />
