									...
									<div class="col-md-12 col-lg-12"
										...
										<div class="row">
											<div class="col-md-12 col-lg-12 ed-action-btn">
												<sec:ifAnyGranted roles="ROLE_CONTENT_MANAGER, ROLE_USER_ADMIN, ROLE_SUPER_ADMIN">
													<g:link class="btn ed-save" action="edit" id="${contentManagerInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
												</sec:ifAnyGranted>
